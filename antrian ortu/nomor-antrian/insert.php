...
$db = 'SELECT * FROM tb_login WHERE id ='.$_SESSION['id'];
...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
  ...
  $query = mysqli_query($mysqli, "SELECT max(no_antrian) as nomor FROM tbl_antrian_ortu WHERE tanggal='$tanggal'")
  ...
  $insert = mysqli_query($mysqli, "INSERT INTO tbl_antrian_ortu(tanggal,no_antrian,nama,hp) 
                                   VALUES('$tanggal', '$no_antrian','$nama','$hp')")
