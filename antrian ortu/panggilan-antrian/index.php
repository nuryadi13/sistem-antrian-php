<?php
$connect = mysqli_connect("localhost", "root", "", "db_antrian");
$db = 'SELECT * FROM tbl_antrian_ortu';
    ...
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="d-flex align-items-center me-md-auto">
          ...
          <h1 class="h5 pt-2">Panggilan Antrian Siswa</h1>
        </div>
        <!-- breadcrumbs -->
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../../tugas/admin/siswa/data.php"><i class="bi-house-fill text-success"></i></a></li>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2021 - jasaprogramwebsite. All rights reserved.
      </div>
    </div>
  </footer>
          ...
          },
          {
            ...
            "render": function(data, type, row) {
              ...
              // jika data "status = 0"
                ...
                var btn = "<button class=\"btn btn-success btn-sm rounded-circle\"><i class=\"bi-mic-fill\"></i></button>&nbsp;&nbsp;&nbsp;<a href=\"https://wa.me/<?php echo $data['hp']; ?>?text=contoh%20isi%20pesan%20dikirim%20via%20whatsapp\"><img src=\"contact_us.png\" style=\"height:44px;width:auto;\"></a>";
                
              } 
              // jika data "status = 1"
              else if (data["status"] === "1") {
                // tampilkan button ulangi panggilan
                var btn = "<button class=\"btn btn-secondary btn-sm rounded-circle\"><i class=\"bi-mic-fill\"></i></button>&nbsp;&nbsp;&nbsp;<a href=\"https://wa.me/<?php echo $data['hp']; ?>?text=contoh%20isi%20pesan%20dikirim%20via%20whatsapp\"><img src=\"contact_us.png\" style=\"height:44px;width:auto;\"></a>";
              };
              return btn;
            }
          },
