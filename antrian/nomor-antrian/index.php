      ...
      <div class="row justify-content-lg-center">
        <div class="col-lg-5 mb-4">
          <div class="px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
            ...
            <a href="../../tugas/siswa/pengajuan/data.php" class="btn btn-success">kembali</a>
          </div>
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body text-center d-grid p-5">
              ...
              <button  onclick="myFunction()" id="insert" href="javascript:void(0)" class="btn btn-success btn-block rounded-pill fs-5 px-5 py-4 mb-2">
