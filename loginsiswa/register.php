			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter username">
						<span class="focus-input100">Usernmae</span><br>
					...
					<span class="focus-input100">Handphone</span><br>
                        ...
                        <input class="input100" type="hidden" name="akses" value="siswa">
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter Phone Class">
					<span class="focus-input100">Class</span><br>
						<input class="input100" type="text" name="kelas">
					</div>
						<select name="jk" id="">
				...
				if (isset($_POST['submit'])) {
					...
					$validasi=$conn->query("SELECT * FROM tb_siswa WHERE username='$username'");
					$q_validasi=$validasi->fetch_assoc();
					if ($nama == '' || $username == '' || $password == '' || $kelas == '' || $jk == '' || $hp == '' || $akses == '') {
						...
						$query=$conn->query("INSERT INTO tb_siswa(nama,username,password,kelas,jk,hp,akses) VALUES('$nama','$username','$password','$kelas','$jk','$hp','$akses')");
						if ($query) {
							echo "<br>";
